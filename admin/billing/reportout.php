...
<div class="table-responsive">
							<table class="table table-dark table-striped">
                                    <thead>
                                        <tr>
                                            <th><h5 style="color: red;"><B>OUTPATIENT BILLING REPORT-->
...
<th>(OUT-PATIENT) NUMBER OF BILLS</th>
<th>    <?php
//$sql ="SELECT billingnos from  invoice_order";
$sql = "SELECT invoice_order.billingnos from  invoice_order where ptype = 'OUT-PATIENT' ";
...
<tbody style="background-color: red;color: white;"  >
    <tr>
    <th>(OUT-PATIENT) NUMBER OF PATIENT</th>
    <th>
    <?php
$sql ="SELECT hospitalnos from  patientinfo where ptype = 'OUT-PATIENT'";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$bg=$query->rowCount();
